...
<section class="hero" style="background: url('images/web/swizchem-banner.jpg');">
    <div class="container">
        <button class="btn btn-yellow mb-5 sub-heading-btn">Custom Proposal – Start Here</button>
        <h1 class="display-4 fw-bold">Where Research Meets<br>Reliable Chemistry</h1>
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            ...
            <div class="col-md-6">
                ...
                <a href="#" class="btn btn-yellow mt-3">Learn More</a>
            </div>
        </div>
    </div>
</section>
